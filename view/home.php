        ...
        <?php foreach ($sectionsWithProducts as $section): ?>
            <div class="container mt-4">
                <div class="scrollable-product-list position-relative">
                    ...
                    <button class="scroll-btn prev-btn" onclick="scrollRowLeft(this.parentElement.querySelector('.product-row'))">
                        <span>&#10094;</span>
                    </button>
                    ...
                    <button class="scroll-btn next-btn" onclick="scrollRowRight(this.parentElement.querySelector('.product-row'))">
                        <span>&#10095;</span>
                    </button>
                </div>
            </div>
